...
We could count every green noodle but that would be tedious! `r emo::ji("weary")` What else could we do?
...
.pull-left[
* We counted the exact number of green, red and yellow noodles in the bowl `r emo::ji("monocle")` `#confinement`
...
`r emo::ji("point_right")` `r sample_1$prop_green` are green! This is an ***estimate*** of the proportion of green noodles in the bowl. What if we try again?
