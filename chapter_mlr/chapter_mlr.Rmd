...
author: "Florian Oswald, Gustave Kenedi, Mylène Feuillade and Junnan He"
...
`r emo::ji("warning")` you have to pay attention to the ***omitted/reference category***: the "baseline" category from which the coefficients are interpreted. Remember:
